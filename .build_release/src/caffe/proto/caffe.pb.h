...
class LayerParameter : public ::google::protobuf::Message {
 public:
  ...
  // optional .caffe.ContinuationIndicatorParameter continuation_indicator_param = 160;
  inline bool has_continuation_indicator_param() const;
  inline void clear_continuation_indicator_param();
  static const int kContinuationIndicatorParamFieldNumber = 160;
...
class VideoDataParameter : public ::google::protobuf::Message {
 public:
  ...
  // optional uint32 top_size = 15 [default = 3];
  inline bool has_top_size() const;
  inline void clear_top_size();
  static const int kTopSizeFieldNumber = 15;
  inline ::google::protobuf::uint32 top_size() const;
  inline void set_top_size(::google::protobuf::uint32 value);

  // optional uint32 gap_example = 16 [default = 1];
  inline bool has_gap_example() const;
  inline void clear_gap_example();
  static const int kGapExampleFieldNumber = 16;
  inline ::google::protobuf::uint32 gap_example() const;
  inline void set_gap_example(::google::protobuf::uint32 value);

  // repeated uint32 ignore_example_label = 17;
  inline int ignore_example_label_size() const;
  inline void clear_ignore_example_label();
  static const int kIgnoreExampleLabelFieldNumber = 17;
  inline ::google::protobuf::uint32 ignore_example_label(int index) const;
  inline void set_ignore_example_label(int index, ::google::protobuf::uint32 value);
  inline void add_ignore_example_label(::google::protobuf::uint32 value);
  inline const ::google::protobuf::RepeatedField< ::google::protobuf::uint32 >&
      ignore_example_label() const;
  inline ::google::protobuf::RepeatedField< ::google::protobuf::uint32 >*
      mutable_ignore_example_label();

  // optional bool is_avg = 18 [default = false];
  inline bool has_is_avg() const;
  inline void clear_is_avg();
  static const int kIsAvgFieldNumber = 18;
  inline bool is_avg() const;
  inline void set_is_avg(bool value);
 ...
 private:
  ...
  inline void set_has_gap_example();
  inline void clear_has_gap_example();
  inline void set_has_is_avg();
  inline void clear_has_is_avg();
  ...
  bool is_avg_;
  ::std::string* root_folder_;
  ::google::protobuf::uint32 top_size_;
  ::google::protobuf::uint32 gap_example_;
  ::google::protobuf::RepeatedField< ::google::protobuf::uint32 > ignore_example_label_;
  friend void  protobuf_AddDesc_caffe_2eproto();
  friend void protobuf_AssignDesc_caffe_2eproto();
  friend void protobuf_ShutdownFile_caffe_2eproto();
...
inline const ::caffe::BlobShape& ConvolutionParameter::pad_shape() const {
  // @@protoc_insertion_point(field_get:caffe.ConvolutionParameter.pad_shape)
...
inline ::caffe::BlobShape* ConvolutionParameter::mutable_pad_shape() {
  ...
  // @@protoc_insertion_point(field_mutable:caffe.ConvolutionParameter.pad_shape)
  return pad_shape_;
}
...
inline void ConvolutionParameter::set_allocated_pad_shape(::caffe::BlobShape* pad_shape) {
  ...
  // @@protoc_insertion_point(field_set_allocated:caffe.ConvolutionParameter.pad_shape)
}
...
inline const ::caffe::BlobShape& ConvolutionParameter::kernel_shape() const {
  // @@protoc_insertion_point(field_get:caffe.ConvolutionParameter.kernel_shape)
...
inline ::caffe::BlobShape* ConvolutionParameter::mutable_kernel_shape() {
  ...
  // @@protoc_insertion_point(field_mutable:caffe.ConvolutionParameter.kernel_shape)
...
inline void ConvolutionParameter::set_allocated_kernel_shape(::caffe::BlobShape* kernel_shape) {
  ...
  // @@protoc_insertion_point(field_set_allocated:caffe.ConvolutionParameter.kernel_shape)
}
...
inline const ::caffe::BlobShape& ConvolutionParameter::stride_shape() const {
  // @@protoc_insertion_point(field_get:caffe.ConvolutionParameter.stride_shape)
...
inline ::caffe::BlobShape* ConvolutionParameter::mutable_stride_shape() {
  ...
  // @@protoc_insertion_point(field_mutable:caffe.ConvolutionParameter.stride_shape)
...
inline void ConvolutionParameter::set_allocated_stride_shape(::caffe::BlobShape* stride_shape) {
  ...
  // @@protoc_insertion_point(field_set_allocated:caffe.ConvolutionParameter.stride_shape)
}
...
inline ::google::protobuf::int32 ContinuationIndicatorParameter::time_step() const {
  // @@protoc_insertion_point(field_get:caffe.ContinuationIndicatorParameter.time_step)
  return time_step_;
}
inline void ContinuationIndicatorParameter::set_time_step(::google::protobuf::int32 value) {
  set_has_time_step();
  time_step_ = value;
...
inline ::google::protobuf::int32 ContinuationIndicatorParameter::batch_size() const {
  // @@protoc_insertion_point(field_get:caffe.ContinuationIndicatorParameter.batch_size)
  return batch_size_;
}
inline void ContinuationIndicatorParameter::set_batch_size(::google::protobuf::int32 value) {
  set_has_batch_size();
  batch_size_ = value;
...
// optional bool flag = 3 [default = false];
inline bool ContinuationIndicatorParameter::has_flag() const {
  return (_has_bits_[0] & 0x00000004u) != 0;
}
inline void ContinuationIndicatorParameter::set_has_flag() {
  _has_bits_[0] |= 0x00000004u;
}
inline void ContinuationIndicatorParameter::clear_has_flag() {
  _has_bits_[0] &= ~0x00000004u;
}
inline void ContinuationIndicatorParameter::clear_flag() {
  flag_ = false;
  clear_has_flag();
}
inline bool ContinuationIndicatorParameter::flag() const {
  // @@protoc_insertion_point(field_get:caffe.ContinuationIndicatorParameter.flag)
  return flag_;
}
inline void ContinuationIndicatorParameter::set_flag(bool value) {
  set_has_flag();
  flag_ = value;
  // @@protoc_insertion_point(field_set:caffe.ContinuationIndicatorParameter.flag)
}
...
inline ::google::protobuf::uint32 MemoryDataParameter::length() const {
  // @@protoc_insertion_point(field_get:caffe.MemoryDataParameter.length)
  return length_;
}
inline void MemoryDataParameter::set_length(::google::protobuf::uint32 value) {
  set_has_length();
  length_ = value;
  // @@protoc_insertion_point(field_set:caffe.MemoryDataParameter.length)
}
...
inline const ::caffe::BlobShape& PoolingParameter::pad_shape() const {
  // @@protoc_insertion_point(field_get:caffe.PoolingParameter.pad_shape)
  return pad_shape_ != NULL ? *pad_shape_ : *default_instance_->pad_shape_;
}
inline ::caffe::BlobShape* PoolingParameter::mutable_pad_shape() {
  set_has_pad_shape();
  if (pad_shape_ == NULL) pad_shape_ = new ::caffe::BlobShape;
  // @@protoc_insertion_point(field_mutable:caffe.PoolingParameter.pad_shape)
  return pad_shape_;
}
...
inline void PoolingParameter::set_allocated_pad_shape(::caffe::BlobShape* pad_shape) {
  ...
  // @@protoc_insertion_point(field_set_allocated:caffe.PoolingParameter.pad_shape)
}
...
inline const ::caffe::BlobShape& PoolingParameter::kernel_shape() const {
  // @@protoc_insertion_point(field_get:caffe.PoolingParameter.kernel_shape)
  return kernel_shape_ != NULL ? *kernel_shape_ : *default_instance_->kernel_shape_;
}
inline ::caffe::BlobShape* PoolingParameter::mutable_kernel_shape() {
  set_has_kernel_shape();
  if (kernel_shape_ == NULL) kernel_shape_ = new ::caffe::BlobShape;
  // @@protoc_insertion_point(field_mutable:caffe.PoolingParameter.kernel_shape)
  return kernel_shape_;
}
...
inline void PoolingParameter::set_allocated_kernel_shape(::caffe::BlobShape* kernel_shape) {
  ...
  // @@protoc_insertion_point(field_set_allocated:caffe.PoolingParameter.kernel_shape)
}
...
inline const ::caffe::BlobShape& PoolingParameter::stride_shape() const {
  // @@protoc_insertion_point(field_get:caffe.PoolingParameter.stride_shape)
  return stride_shape_ != NULL ? *stride_shape_ : *default_instance_->stride_shape_;
}
inline ::caffe::BlobShape* PoolingParameter::mutable_stride_shape() {
  set_has_stride_shape();
  if (stride_shape_ == NULL) stride_shape_ = new ::caffe::BlobShape;
  // @@protoc_insertion_point(field_mutable:caffe.PoolingParameter.stride_shape)
  return stride_shape_;
}
...
inline void PoolingParameter::set_allocated_stride_shape(::caffe::BlobShape* stride_shape) {
  ...
  // @@protoc_insertion_point(field_set_allocated:caffe.PoolingParameter.stride_shape)
}
...
// optional bool is_flow = 14 [default = false];
inline bool VideoDataParameter::has_is_flow() const {
  return (_has_bits_[0] & 0x00000200u) != 0;
}
inline void VideoDataParameter::set_has_is_flow() {
  _has_bits_[0] |= 0x00000200u;
}
inline void VideoDataParameter::clear_has_is_flow() {
  _has_bits_[0] &= ~0x00000200u;
}
inline void VideoDataParameter::clear_is_flow() {
  is_flow_ = false;
  clear_has_is_flow();
}
inline bool VideoDataParameter::is_flow() const {
  // @@protoc_insertion_point(field_get:caffe.VideoDataParameter.is_flow)
  return is_flow_;
}
inline void VideoDataParameter::set_is_flow(bool value) {
  set_has_is_flow();
  is_flow_ = value;
  // @@protoc_insertion_point(field_set:caffe.VideoDataParameter.is_flow)
}

// optional uint32 top_size = 15 [default = 3];
inline bool VideoDataParameter::has_top_size() const {
  return (_has_bits_[0] & 0x00000400u) != 0;
}
inline void VideoDataParameter::set_has_top_size() {
  _has_bits_[0] |= 0x00000400u;
}
inline void VideoDataParameter::clear_has_top_size() {
  _has_bits_[0] &= ~0x00000400u;
}
inline void VideoDataParameter::clear_top_size() {
  top_size_ = 3u;
  clear_has_top_size();
}
inline ::google::protobuf::uint32 VideoDataParameter::top_size() const {
  // @@protoc_insertion_point(field_get:caffe.VideoDataParameter.top_size)
  return top_size_;
}
inline void VideoDataParameter::set_top_size(::google::protobuf::uint32 value) {
  set_has_top_size();
  top_size_ = value;
  // @@protoc_insertion_point(field_set:caffe.VideoDataParameter.top_size)
}

// optional uint32 gap_example = 16 [default = 1];
inline bool VideoDataParameter::has_gap_example() const {
  return (_has_bits_[0] & 0x00000800u) != 0;
}
inline void VideoDataParameter::set_has_gap_example() {
  _has_bits_[0] |= 0x00000800u;
}
inline void VideoDataParameter::clear_has_gap_example() {
  _has_bits_[0] &= ~0x00000800u;
}
inline void VideoDataParameter::clear_gap_example() {
  gap_example_ = 1u;
  clear_has_gap_example();
}
inline ::google::protobuf::uint32 VideoDataParameter::gap_example() const {
  // @@protoc_insertion_point(field_get:caffe.VideoDataParameter.gap_example)
  return gap_example_;
}
inline void VideoDataParameter::set_gap_example(::google::protobuf::uint32 value) {
  set_has_gap_example();
  gap_example_ = value;
  // @@protoc_insertion_point(field_set:caffe.VideoDataParameter.gap_example)
}

// repeated uint32 ignore_example_label = 17;
inline int VideoDataParameter::ignore_example_label_size() const {
  return ignore_example_label_.size();
}
inline void VideoDataParameter::clear_ignore_example_label() {
  ignore_example_label_.Clear();
}
inline ::google::protobuf::uint32 VideoDataParameter::ignore_example_label(int index) const {
  // @@protoc_insertion_point(field_get:caffe.VideoDataParameter.ignore_example_label)
  return ignore_example_label_.Get(index);
}
inline void VideoDataParameter::set_ignore_example_label(int index, ::google::protobuf::uint32 value) {
  ignore_example_label_.Set(index, value);
  // @@protoc_insertion_point(field_set:caffe.VideoDataParameter.ignore_example_label)
}
inline void VideoDataParameter::add_ignore_example_label(::google::protobuf::uint32 value) {
  ignore_example_label_.Add(value);
  // @@protoc_insertion_point(field_add:caffe.VideoDataParameter.ignore_example_label)
}
inline const ::google::protobuf::RepeatedField< ::google::protobuf::uint32 >&
VideoDataParameter::ignore_example_label() const {
  // @@protoc_insertion_point(field_list:caffe.VideoDataParameter.ignore_example_label)
  return ignore_example_label_;
}
inline ::google::protobuf::RepeatedField< ::google::protobuf::uint32 >*
VideoDataParameter::mutable_ignore_example_label() {
  // @@protoc_insertion_point(field_mutable_list:caffe.VideoDataParameter.ignore_example_label)
  return &ignore_example_label_;
}

// optional bool is_avg = 18 [default = false];
inline bool VideoDataParameter::has_is_avg() const {
  return (_has_bits_[0] & 0x00002000u) != 0;
}
inline void VideoDataParameter::set_has_is_avg() {
  _has_bits_[0] |= 0x00002000u;
}
inline void VideoDataParameter::clear_has_is_avg() {
  _has_bits_[0] &= ~0x00002000u;
}
inline void VideoDataParameter::clear_is_avg() {
  is_avg_ = false;
  clear_has_is_avg();
}
inline bool VideoDataParameter::is_avg() const {
  // @@protoc_insertion_point(field_get:caffe.VideoDataParameter.is_avg)
  return is_avg_;
}
inline void VideoDataParameter::set_is_avg(bool value) {
  set_has_is_avg();
  is_avg_ = value;
  // @@protoc_insertion_point(field_set:caffe.VideoDataParameter.is_avg)
}
